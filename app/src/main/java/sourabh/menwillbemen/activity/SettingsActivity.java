...
//        if (key.equals(getResources().getString(R.string.pref_key_animation))) {
//
//            SwitchPreference sp = (SwitchPreference) findPreference(key);
//        Preference connectionPref = getPreferenceManager().findPreference(key);
//
//        if (getPreferenceManager().getSharedPreferences().getBoolean(getResources().getString(R.string.pref_key_animation), true)){
//            // Your switch is on
//        } else {
//            // Your switch is off
//        }}
...
//        restartActivity();
    ...
    private void sendMessage() {
        ...
        Intent intent = new Intent(AppConfig.KEY_SETTINGS_CHANGED);
...
//            findPreference(COLOR_PICKER_KEY).setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
//                @Override
...
//
//            int color = PreferenceManager.getDefaultSharedPreferences(getActivity()).getInt(COLOR_PICKER_KEY, Color.YELLOW);
